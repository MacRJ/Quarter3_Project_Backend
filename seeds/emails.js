  ...
  return knex('emails').del()
    .then(function () {
      ...
      return knex('emails').insert([
        ...
        {id: 13, user_id: 1, from: 'Marge Simpson' ,subject: 'Ted Bundy is a stalker', email: 'is simply dummy text of the printing and typesetting industry', note_attached: true, timed_activity: true, clicked: false, selected: false},
